...
url = "http://wsusserverFQDNorIP/machines.txt"
urlUpdate = "http://wsusserverFQDNorIP/SUS_update.vbs.txt"
...
' precedence
strMailto = "mcolatosti@contoso.com"

'set SMTP email server address here
strSMTPServer = "mail.contoso.com"
